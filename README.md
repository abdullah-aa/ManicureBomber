# ManicureBomber - Bomber Combat Simulator

A high-performance WebGL combat simulator featuring a Bomber with realistic flight dynamics, terrain generation, and missile combat systems.

## Features

### Core Gameplay

- **Realistic Bomber Flight**: Banking turns, altitude control, and smooth flight dynamics
