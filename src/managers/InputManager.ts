...
export class InputManager {
  ...
  public isShiftUpPressed(): boolean {
    return (
      (this.isKeyPressed('ShiftLeft') && this.isKeyPressed('ArrowUp')) ||
  ...
  public isShiftDownPressed(): boolean {
    return (
      (this.isKeyPressed('ShiftLeft') && this.isKeyPressed('ArrowDown')) ||
  ...
  public isShiftLeftBracketPressed(): boolean {
    return (
      (this.isKeyPressed('ShiftLeft') && this.isKeyPressed('BracketLeft')) ||
  ...
  public isShiftRightBracketPressed(): boolean {
    return (
      (this.isKeyPressed('ShiftLeft') && this.isKeyPressed('BracketRight')) ||
  ...
  public isCtrlUpPressed(): boolean {
    return (
      (this.isKeyPressed('ControlLeft') && this.isKeyPressed('ArrowUp')) ||
  ...
  public isCtrlDownPressed(): boolean {
    return (
      (this.isKeyPressed('ControlLeft') && this.isKeyPressed('ArrowDown')) ||
