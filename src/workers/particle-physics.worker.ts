...
function updateParticlePhysics(data: ParticleSystemData): ParticlePhysicsResult {
  ...
  data.particles.forEach((particle) => {
    ...
    switch (particle.type) {
      case 'fire':
        newColor = colorLerp({ r: 1, g: 0.8, b: 0, a: 1 }, { r: 0.3, g: 0.1, b: 0, a: 0 }, lifeRatio);
        break;
      case 'smoke':
        newColor = colorLerp({ r: 0.5, g: 0.5, b: 0.5, a: 0.6 }, { r: 0.2, g: 0.2, b: 0.2, a: 0 }, lifeRatio);
        break;
      case 'spark':
        newColor = colorLerp({ r: 1, g: 1, b: 0.8, a: 1 }, { r: 1, g: 0.6, b: 0.2, a: 0 }, lifeRatio);
        break;
      case 'exhaust':
        newColor = colorLerp({ r: 1, g: 0.4, b: 0.1, a: 1 }, { r: 0.3, g: 0.1, b: 0.02, a: 0.1 }, lifeRatio);
        break;
      case 'trail':
        newColor = colorLerp({ r: 0.8, g: 0.9, b: 1.0, a: 0.6 }, { r: 0.2, g: 0.3, b: 0.5, a: 0 }, lifeRatio);
        break;
    }
...
function createParticles(
  ...
  for (let i = 0; i < count; i++) {
    const spreadVector = randomVector3({ x: -spread, y: -spread, z: -spread }, { x: spread, y: spread, z: spread });
